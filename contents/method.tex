...
include but are not limited to: humans, chairs, other wheelchairs, tables and cabinets.
...
function that is exhaustively evaluated for every configuration, and the
configuration with the maximum potential is chosen.
