...
% ====================
We formulate the problem as follows: Bayesian/MDP formulation
...
Ten different instances are recorded. In each instance, the wheelchair starts
...
$ax + by + cz + d = 0$. Lines 7-9 highlight an additional constraint to avoid
detecting vertical planar surfaces (i.e. walls).
...
primitive transition curves of a differential drive system \cite{balkcom2002time}. 
...
empirical evaluation, and choose a pareto optimal combination of each.
...
different values for $\theta$. Blue represents low desirability, yellow
represents high desirability. Infeasible configurations determined in 
