...
\title{Placing Robots to Minimize Obstructions}
...
\usepackage{amsthm} % for \theoremstyle{definition}\begin{definition}{DefinitionName}
\theoremstyle{definition}
\newtheorem{definition}{Definition}[section]
 
% for proofs, remarks, definitions. See below for examples
\theoremstyle{remark}
